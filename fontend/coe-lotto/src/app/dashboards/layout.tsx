...
import Marquee from "react-fast-marquee"; // Correct import (capitalized)
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  }, []); // Removed router and pathname from dependencies
  ...
  const userNavigation = [
    ...
    {
      name: isLoggedIn ? "Sign out" : "Log in",
      href: isLoggedIn ? "#" : "/dashboards/login",
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <div className="shrink-0 mt-4">
                <img alt="Logo" src="/coe-lotto.png" className="w-32 h-24" />
              </div>
        ...
        <DisclosurePanel className="md:hidden">
          ...
          <div className="border-t border-gray-700 pt-4 pb-3">
            ...
            <div className="mt-3 space-y-1 px-2">
              {userNavigation.map((item) => (
                <Link href={item.href} key={item.name} onClick={item.onClick}>
